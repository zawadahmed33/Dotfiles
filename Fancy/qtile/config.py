...
widget_defaults = dict(
    font="JetBrains Mono SemiBold", fontsize=14, padding=12, foreground=colors[1]
)
        ...
        top=bar.Bar(
            [
                ...
                widget.TextBox(
                    ...
                    foreground=colors[6],
                    decorations=[
                        BorderDecoration(padding_y=8, border_width=1, colour=colors[6])
                    ],
                ),
                widget.Spacer(length=8),
                widget.GroupBox(
                    ...
                    decorations=[
                        BorderDecoration(padding_y=8, border_width=1, colour=colors[1])
                    ],
                ),
